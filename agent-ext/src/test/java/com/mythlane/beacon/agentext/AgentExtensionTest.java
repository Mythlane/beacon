...
/**
 * Covers FND-03 (agent extension SPI). Replaces Wave 0 stub (Plan 03 of phase 01).
 *
 * <p>These tests exercise {@link BeaconResourceProvider} directly (the {@link BeaconExtension}
 * SPI wiring is verified by the META-INF/services classpath assertion in
 * {@link #spiServiceFileIsOnClasspathAndPointsToBeaconExtension()}).
 */
class AgentExtensionTest {
    ...
    void spiServiceFileIsOnClasspathAndPointsToBeaconExtension() throws Exception {
        ...
        assertThat(url).as("SPI service file must be generated by AutoService").isNotNull();
